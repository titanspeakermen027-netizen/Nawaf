...
PREFIX_COMMANDS = {
    ...
    "🛡️ الإدارة": [
        ...
        ("-تقييم", "فتح واجهة تقييم التذكرة المغلقة"),
        ("سجن @user", "سجن عضو واسترجاع رتبه عند العفو"),
        ("عفو @user", "فك السجن واسترجاع الرتب"),
        ("قفل [#روم]", "قفل روم نصية أمام @everyone"),
        ("فتح [#روم]", "فتح الروم وإرجاع صلاحية الكتابة للوضع الموروث"),
        ("تبنيد @user [السبب]", "تبنيد عضو"),
        ("فك_باند ID", "فك تبنيد عضو باستعمال ID"),
        ("كيك @user [السبب]", "طرد عضو"),
        ("اعطاء @user @role", "إعطاء رتبة لعضو"),
        ("ازالة @user @role", "إزالة رتبة من عضو"),
        ("تايم @user 10m", "إعطاء تايم لمدة محددة، حتى 28 يوم"),
        ("فكتايم @user", "فك التايم عن عضو"),
    ],
}
