...
def init_db():
    with connect() as con:
        ...
        CREATE TABLE IF NOT EXISTS guild_config (
            ...
            jail_role_id INTEGER, jail_channel_id INTEGER, individual_game_channel INTEGER
        );
        CREATE TABLE IF NOT EXISTS tickets (
            channel_id INTEGER PRIMARY KEY, guild_id INTEGER NOT NULL, owner_id INTEGER NOT NULL,
            closed_by INTEGER, closed_at TEXT, rating INTEGER, note TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP
        );
        ...
        CREATE TABLE IF NOT EXISTS level_rewards (guild_id INTEGER NOT NULL, level INTEGER NOT NULL, role_id INTEGER NOT NULL, enabled INTEGER DEFAULT 1, PRIMARY KEY (guild_id,level));
        ...
        CREATE TABLE IF NOT EXISTS shop_orders (id INTEGER PRIMARY KEY AUTOINCREMENT, guild_id INTEGER NOT NULL, user_id INTEGER NOT NULL, product_id INTEGER NOT NULL, quantity INTEGER NOT NULL, total_price INTEGER NOT NULL, status TEXT DEFAULT 'pending', details TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP);
        CREATE TABLE IF NOT EXISTS jails (guild_id INTEGER NOT NULL, user_id INTEGER NOT NULL, previous_roles TEXT DEFAULT '[]', expires_at TEXT, jailed_by INTEGER NOT NULL, created_at TEXT DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (guild_id,user_id));
        """)
        ...
        add_column("guild_config", "individual_game_channel", "INTEGER")
